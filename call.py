...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* 8 Clouds with staggered negative delays */
...
<body>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      // Cloud words array for hover (for clouds' internal words remain as before)
      ...
      // Tag Selection Overlay reference
        ...
        tagBtn.addEventListener('click', () => {
          ...
          if (tagBtn.classList.contains('selected')) {
            ...
            if (selectedTags.length < 3) {
              ...
              // If already 3 selected, optionally alert or ignore additional clicks
      ...
      tagSubmit.addEventListener('click', () => {
        // Save selected tags in localStorage and redirect to next page
      ...
      document.getElementById('signInSubmit').addEventListener('click', async () => {
        ...
        try {
          ...
          if (response.ok) {
            ...
            // Show welcome overlay animation
            welcomeOverlay.innerText = "Welcome, " + result + "!";
            welcomeOverlay.classList.remove('hidden');
            setTimeout(() => {
              welcomeOverlay.classList.add('show');
            }, 100);
            // After 2 seconds, hide welcome overlay and show tag selection overlay
            setTimeout(() => {
